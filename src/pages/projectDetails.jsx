            ...
            <div className="content">
                ...
                <div className="content-three">
                    <div className="description">
                        <p>Description</p>
                        <button onClick={dropdwnDesc} className="drop"><i className={isopenDesc === false?"fa-solid fa-chevron-up":"fa-solid fa-chevron-down"}></i></button>
                    </div>
                    <div className="equipements">
                        <p>Équipements</p>
                        <button onClick={dropdwnEqu} className="drop"><i className={isopenEqu === false?"fa-solid fa-chevron-up":"fa-solid fa-chevron-down"}></i></button>
                    </div>
                </div>
